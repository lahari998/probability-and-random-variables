\let\negmedspace\undefined 
 ...
 \begin{enumerate}[label=(\alph*)] 
	 \item   The  generating function of $X$ is  
		 ...
		 \item	We have 
			\begin{align}
				G_X(z) &= \frac{z}{2} + \frac{z^{6}}{2} 
			\end{align}
			 \begin{align}
				 G_Y(z) &= \frac{\sum_{n=1}^{6} z^{n}}{6} 
			 \end{align}
			\begin{align}
				G_Z(z) &= (\frac{\sum_{n=1}^{6} z^{n}}{6})(\frac{z + z^{6}}{2}) 
                        \end{align}
		\item probability of Z=z is its coefficient in G(z).Hence from eqns (3),(4),(5) we get
	   \begin{align}
