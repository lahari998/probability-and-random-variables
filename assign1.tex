\let\negmedspace\undefined 
 ...
 \begin{enumerate}[label=(\alph*)] 
	 \item   The  generating function of $X$ is  
                         \begin{align} 
				 M_X(z) &= E[z^{X}] 
                                = \sum_{i=0}^{\infty}\pr{X = i}z^{-i}  
                         \end{align} 
		 \item Let us define a random variable $Z$,Let X and Y are independent random variables then 
			 \begin{align}
				 M_Z(z) &= E[z^{X + Y}] 
					 = E[e^{X}e^{Y}] = E[z^{X}]E[z^{Y}] 
					 = M_X(z)M_Y(z) 
			 \end{align} 
		 \item	We have 
			\begin{align}
				M_X(z) &= \Big( z^{-1} \Big)\Big ( \frac{1}{2} \Big) + \Big( z^{-1} \Big)\Big ( \frac{1}{2} \Big) 
			\end{align}
			 \begin{align}
				 M_Y(z) &= \sum_{n=1}^{6} \Big( z^{-n} \Big)\Big ( \frac{1}{6} \Big) 
			 \end{align}
			\begin{align}
				M_Z(z) &= \Big [ \Big( z^{-1} \Big)\Big ( \frac{1}{2} \Big) + \Big( z^{-1} \Big)\Big ( \frac{1}{2} \Big) \Big]\Big [\sum_{n=1}^{6} \Big( z^{-n} \Big)\Big ( \frac{1}{6} \Big) \Big ]
                        \end{align}
		\item probability of Z=i is coefficient of $z^{-i}$ in $M_Z(z)$.Hence from eqns (3),(4),(5) we get
	   \begin{align}
			      \pr{Z = 3} &= (\frac{1}{6})(\frac{1}{2}) \\ 
		      &= \frac{1}{12}
	      \end{align}
      
              \begin{align}
		      \pr{Z = 12} &= (\frac{1}{6})(\frac{1}{2}) \\
		      &= \frac{1}{12}
	      \end{align}
 \end{enumerate} 
 \end{document}
